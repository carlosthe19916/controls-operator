...
@ApplicationScoped
public class KeycloakDBSubController implements SubController {

    @Inject
    KubernetesClient kubernetesClient;

    @Inject
    @ResourcePath("keycloak-db/secret.yaml")
    Template secretTemplate;

    @Inject
    @ResourcePath("keycloak-db/pvc.yaml")
    Template pvcTemplate;

    @Inject
    @ResourcePath("keycloak-db/service.yaml")
    Template serviceTemplate;

    @Inject
    @ResourcePath("keycloak-db/deployment.yaml")
